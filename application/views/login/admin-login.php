...
<html>
    ...
    <style>
      ...
      #bg {
        ...
        width: 100%;
        height: 100%;
        /* background: url('<?php echo base_url(); ?>assets/dashboard/images/admin/bg.jpg') no-repeat center center fixed; */
    ...
    <div id="bg"></div>
     ...
     <div class="container"> 
      <div class="row">
        <div class="col-md-12">
          <h2 class="text-center lead" style="color:#fff">Ecommerce Solution Admin Panel</h2>
        </div>
      </div>
    </div> 
