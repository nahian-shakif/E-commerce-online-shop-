...
$config['useragent']        = 'PHPMailer'; // Mail Engine              // Mail engine switcher: 'CodeIgniter' or 'PHPMailer'
$config['protocol']         = 'smtp';     // Protocol we used              // 'mail', 'sendmail', or 'smtp'
...
$config['smtp_user']        = 'shakif013@gmail.com';
$config['smtp_pass']        = 'Nahian13';
